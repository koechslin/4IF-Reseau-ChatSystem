...
public class ChatServer {
    ...
    /**
    * main method
    * Connect the server to the group, save all the 
    * messages and send the history when asking
    **/
    public static void main(String[] args) {
        if (args.length != 3) {
        	System.out.println("Usage: java ChatServer <Group adress> <Group port> <Messages file>");
        	System.exit(1);
        }
